...
package com.song.shiro.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.song.core.properties.SpringBootPlusProperties;
import com.song.shiro.cache.LoginRedisService;
import com.song.shiro.jwt.JwtProperties;
import com.song.shiro.jwt.JwtToken;
import com.song.shiro.param.LoginParam;
import com.song.shiro.util.JwtTokenUtil;
import com.song.shiro.util.JwtUtil;
import com.song.shiro.util.SaltUtil;
import com.song.constant.CommonConstant;
import com.song.constant.CommonRedisKey;
import com.song.enums.StateEnum;
import com.song.shiro.service.LoginService;
import com.song.system.convert.SysUserConvert;
...
//        checkVerifyCode(loginParam.getVerifyToken(), loginParam.getCode());
        ...
        if (StateEnum.DISABLE.getKey().equals(sysUser.getStatus())) {
        ...
        // 将系统用户对象转换成登陆用户对象
        SysUserQueryVo loginSysUserVo = SysUserConvert.INSTANCE.sysUserToLoginSysUserVo(sysUser);
