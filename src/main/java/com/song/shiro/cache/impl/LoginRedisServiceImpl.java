...
package com.song.shiro.cache.impl;

import com.song.shiro.convert.ShiroMapstructConvert;
import com.song.shiro.jwt.JwtProperties;
import com.song.shiro.jwt.JwtToken;
import com.song.shiro.vo.ClientInfo;
...
import com.song.util.ClientInfoUtil;
import com.song.util.HttpServletRequestUtil;
...
public class LoginRedisServiceImpl implements LoginRedisService {
     ...
     */
    @Override
    public void cacheLoginInfo(JwtToken jwtToken, SysUserQueryVo loginSysUserVo) {
        if (jwtToken == null) {
    ...
    @Override
    public  SysUserQueryVo  getLoginSysUserVo(String username) {
        if (StringUtils.isBlank(username)) {
            throw new IllegalArgumentException("username不能为空");
        }
