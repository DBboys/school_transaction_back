...
import com.song.common.ueditor.define.ActionMap;
...
//	private ConfigManager(){}
	...
	public static ConfigManager getInstance ( String rootPath, String contextPath, String uri ) throws IOException {
		try {
			if (null == configManager){
				synchronized (key){
					if (null == configManager){
						configManager = new ConfigManager(rootPath, contextPath, uri);
					}
				}
			}
