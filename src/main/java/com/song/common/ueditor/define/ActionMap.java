package com.song.common.ueditor.define;
...
public final class ActionMap {
	...
	public static final int UPLOAD_IMAGE = 1;// 图片
	public static final int UPLOAD_SCRAWL = 2;
	public static final int UPLOAD_VIDEO = 3;// 视频音频
	public static final int UPLOAD_FILE = 4;// 附件
